    ...
    return(
        <>
            ...
            <div className="flex justify-between mt-3 items-center">
                {pageNumber > 1 ? <button onClick={handlePreviousClick} className="bg-blue-300 p-2 rounded-md"><svg className="w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {pageNumber !== allPages.length && info.length > 0 ? <button onClick={handleNextClick} className="bg-blue-300 p-2 rounded-md"><svg className="w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
